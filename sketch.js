...
Pac_ManImg=loadAnimation("images/Pac-man/Pac1.png","images/Pac-man/Pac2.png")
  Cambio_de_modoa=loadAnimation("images/Fantasma_Cambio_de_modo/F1.gif","images/Fantasma_Cambio_de_modo/F2.gif","images/Fantasma_Cambio_de_modo/F3.gif","images/Fantasma_Cambio_de_modo/F4.gif","images/Fantasma_Cambio_de_modo/F5.gif","images/Fantasma_Cambio_de_modo/F6.gif","images/Fantasma_Cambio_de_modo/F7.gif","images/Fantasma_Cambio_de_modo/F8.gif","images/Fantasma_Cambio_de_modo/F9.gif","images/Fantasma_Cambio_de_modo/F10.gif","images/Fantasma_Cambio_de_modo/F11.gif","images/Fantasma_Cambio_de_modo/F12.gif","images/Fantasma_Cambio_de_modo/F13.gif","images/Fantasma_Cambio_de_modo/F14.gif","images/Fantasma_Cambio_de_modo/F15.gif","images/Fantasma_Cambio_de_modo/F16.gif","images/Fantasma_Cambio_de_modo/F17.gif","images/Fantasma_Cambio_de_modo/F18.gif","images/Fantasma_Cambio_de_modo/F19.gif","images/Fantasma_Cambio_de_modo/F20.gif","images/Fantasma_Cambio_de_modo/F21.gif")
...
function draw() {
  ...
  Pac_Man.overlap(cookies,function(collector,collected){
    collected.remove()
    score=score+1
  });
  ...
  if ( Pac_Man.x>550 &&Pac_Man.y>180 &&Pac_Man.y<220){
   ...
   if(Pac_Man.isTouching(galleta_de_poder_esquina_inferior_derecha)){
    score=score+40
    galleta_de_poder_esquina_inferior_derecha.destroy()
    
   }
   if(Pac_Man.isTouching(galleta_de_poder_esquina_inferior_isquierda)){
    score=score+40
    galleta_de_poder_esquina_inferior_isquierda.destroy()}

    if(Pac_Man.isTouching(galleta_de_poder_esquina_superior_derecha)){
      score=score+40
      galleta_de_poder_esquina_superior_derecha.destroy()
      
     }
     if(Pac_Man.isTouching(galleta_de_poder_esquina_superior_isquierda)){
      score=score+40
    
      galleta_de_poder_esquina_superior_isquierda.destroy()}
  ...
  if ( Pac_Man.x<50 &&Pac_Man.y>180 &&Pac_Man.y<220){
   ...
   if(Pac_Man.isTouching(cereza)){
    score=score+20
    cereza.destroy()

   }
   if(Pac_Man.isTouching(bananas)){
    score=score+20
    bananas.destroy()

   }
   if(Pac_Man.isTouching(naranjas)){
    score=score+20
    naranjas.destroy()

   }
   if(Pac_Man.isTouching(fresas)){
    score=score+20
    fresas.destroy()
...
function galletas(){
for(var i=20;i<600;i=i+30){
  for(var j=20;j<400;j=j+30){
    var cookie= createSprite(i,j,6,6)

    cookie.shapeColor= "#ffff00"
     cookies.add(cookie);
cookie.overlap(wallsGroup,function(collector,collected){
  collector.remove()
})
  }
